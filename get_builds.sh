...
#		2015-01-12 # added support for 2.5 builds
...
DIR_LOC='/home/flash/Desktop/builds'
DIR_SER='/mnt/builds'
CUR_DIR=$DIR_SER
# BUILD_ID='latest'
...
TO_KK_B2G='b2g-43.0a1.en-US.android-arm.tar.gz'
...
TO_KK='/Flame/2.5/Central'
TO_EN='/Flame/2.5/Engineering'
...
#MC_KK_DIR_SER='/mnt/builds/Flame/Flame_KK/2.2/Central'
#MC_EN_DIR_SER='/mnt/builds/Flame/Flame_KK/2.2/Engineering'
MC_KK='/Flame/2.2/b2g37'
MC_EN='/Flame/2.2/Engineering'
...
B34_KK='/Flame/2.1/b2g-34'
B34_EN='/Flame/2.1/Engineering'
...
function pull_2_5() {
  ...
  #cd '/mnt/builds/Flame/Flame_KK/2.5/Central
  cd $CUR_DIR$TO_KK
  pwd
  echo "Starting KK v2.5"
...
function pull_2_5E() {
  ...
  cd $CUR_DIR$TO_EN
  pwd
  echo "Starting KK v2.5 [Nightly Engineering]"
...
function pull_builds_args()
{
	...
	'2.5E') pull_2_5E;;
	'all')
	echo "all -- pulling all builds: 2.5, 2.5E, 2.2, 2.2E, 2.1, 2.1E, 2.0"
	    pull_2_5
	    pull_2_5E
	    pull_2_2
	    pull_2_2E
	    ...
	    ;;
	'2.5X')
	    echo "2.5X -- pulling all 2.5: user + eng"
	    pull_2_5
	    pull_2_5E
	    ;;
	'2.2X')
	...
	echo "engineering -- pulling eng. builds: 2.2E, 2.1E"
	    ...
	    pull_2_1E
	    ;;
	*) echo "No Argument: provide '2.5','2.0', '2.1','2.2', or '2.2E', '2.1E or '2.1TB' to pull a particular build.";;
    esac
}
...
function displayIntro()
{
  ...
  echo "smoke -- latest 2.5, 2.2, 2.1, 2.2E and 2.1E"
  echo "all -- latest 2.5, 2.2, 2.1, 2.0, 2.2E and 2.1E"
  echo "user -- latest 2.5, 2.2, 2.1 and 2.0"
  echo "eng -- latest 2.5, 2.2 and 2.1 Engineering [from nightly]"
  echo "----------------------------------------------------------------"
  echo "Flags:"
